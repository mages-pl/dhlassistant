...
class DhlWrapper
{
	...
	protected static function _CallApiFunction(DataModels\DhlApi $oApi, $sFunctionName, $aParams)
	{
		...
		return call_user_func_array($function_name, $aParams);
	}
	...
	public static function GetPnpReport(DataModels\DhlApi $oApi, DataModels\DhlUser $oDhlUser, \DateTime $oDate, $aParams = null)
	{
