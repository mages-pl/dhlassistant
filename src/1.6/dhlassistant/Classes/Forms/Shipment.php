...
// 		$ViewMode = new ModelsForm('ViewMode');
...
//		$this->AddField((new Models\FormField('HasError', '', 'Hidden'))); //bool: wysyłka ma błąd uniemożliwiający wysłanie zlecenia do DHL
// 		$this->AddField((new Models\FormField('ErrorMessage', '', 'Hidden'))); //string: komunikaty błędów, multiline (\n)
		//Receiver
