...
class Dhl24WebApiWrapper
{
	...
	public static function GetPnpReport(DataModels\DhlUser $oDhlUser, \DateTime $oDate, $aParams = null)
	{
		...
		if (!is_array($aParams) || !isset($aParams['PackageType']) || !isset(Enums\PnpReportPackageType::$Descriptions[$aParams['PackageType']]))
		...
		$request->pnpRequest->type = $aParams['PackageType'];
